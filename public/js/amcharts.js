...
(function () {
    ...
    d.AxisBase = d.Class({
        construct: function (a) {
            ...
            var a, b = this.chart, c = this.showFirstLabel, e = this.showLastLabel, h, f = "", g = d.extractPeriod(this.minPeriod), k = d.getPeriodDuration(g.period, g.count), l, m, n, p, q, r = this.firstDayOfWeek, u = this.boldPeriodBeginning;
...
(function () {
    ...
    d.ValueAxis = d.Class({
        inherits: d.AxisBase, construct: function (a) {
            ...
            1 > c ? (this.maxDecCount = Math.abs(Math.log(Math.abs(c)) * Math.LOG10E), this.maxDecCount = Math.round(this.maxDecCount), this.step = d.roundTo(this.step,
            ...
            if (isNaN(a))return NaN;
            var b = this.rotate, c = this.reversed, e = this.axisWidth, d =
...
(function () {
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, n, p) {
            ...
            n = a.labelRotationR;
            var ea = a.counter, P = a.inside, oa = a.labelOffset, qa = a.dx, ka = a.dy, Qa = a.orientation, ca = a.position, aa = a.previousCoord, V = a.viH, sa = a.viW, ba = a.offset, da, ta;
            ...
            Z && (Z.attr({"text-anchor": fa}), Z.translate(H, x), 0 !== n && Z.rotate(-n, a.chart.backgroundColor), a.allLabels.push(Z), this.label = Z, d.setCN(q, Z, a.bcn + "label"), d.setCN(q, Z, p, !0), g && d.setCN(q, Z, "guide"));
            ...
            if (d.ifArray(b)) {
                ...
                for (e = 0; e < b.length; e++) {
                    ...
                    if (!1 !== h.enabled) {
                        ...
                        isNaN(h.alpha);
                        var k = this.marginLeft, f = d.wrappedText(this.container, h.text, f, this.fontFamily, g, "middle", !0, this.divRealWidth - 20);
        ...
        construct: function (a) {
            ...
            for (m = this.start; m <= this.end; m++) {
                ...
                if (isNaN(p))this.connect || (this.drawLineGraph(b, c, e, d), b = [], c = [], e = [], d = []); else {
                    ...
                    c.push(r);
                    if (!isNaN(q)) {
                        var t = this.y - (this.valueAxis.getCoordinate(q) - this.height), t = t * this.valueAxis.rMultiplier, z = t * Math.sin(u / 180 * Math.PI), u = t * Math.cos(u / 180 * Math.PI);
                        e.push(z);
                        d.push(u);
                        isNaN(k) && (k = z);
                        isNaN(l) && (l = u)
            ...
            if (e) {
                var l = e.graphDataItem, m = this.chart.rotate, n = l.isNegative, p = this.chart, q = this.valueAxis;
                b -= k.height / 4 / 2;
                switch (g) {
                    case"top":
                ...
                c.translate(a, b);
                k = c.getBBox();
                !this.showAllValueLabels && r && f && (k.height > l.columnHeight || k.width > l.columnWidth) && (c.remove(),
                    c = !1);
            ...
            var qa = this.categoryAxis, ka = this.baseCoord, Qa = this.negativeBase, ca = this.columnIndex, aa = this.lineThickness, V = this.lineAlpha, sa = this.lineColorR, ba = this.dashLength, da = this.set, ta, fa = this.getGradRotation(), R = this.chart.columnSpacing, X = qa.cellWidth, wa = (X * k - u) / u;
            R > wa && (R = wa);
            ...
            for (K = W; K <= ea; K++) {
                ...
                var U, Q, M, ha, ma = NaN, G = NaN, F = NaN, N = NaN, L = NaN, Oa = NaN, Ea = NaN, Pa = NaN, Fa = NaN, ya = NaN, za = NaN, ia = NaN, ja = NaN, Y = NaN, vb = NaN, wb = NaN, na = NaN, pa = void 0, Ia = tb, Sa = Wa, Ba = sa, ua, xa, xb = this.proCandlesticks, kb = this.topRadius, $a = this.pattern;
                ...
                if (Ca) {
                    ...
                    var ma = H.x[qa.id], Ta = this.periodSpan - 1, ra = Math.floor(X / 2) + Math.floor(Ta * X / 2), Aa = ra, lb = 0;
                        ...
                        case"step":
                            if (!isNaN(Y)) {
                                ...
                                if (Ya || void 0 != x.lineColor || void 0 != x.fillColors || !isNaN(x.dashLength)) {
                                    var Zb = y[y.length - 2], $b = v[v.length - 2];
                                    y.pop();
                                    v.pop();
                        ...
                        case"candlestick":
                            if (!isNaN(na) && !isNaN(Y)) {
                                ...
                                if (r) {
                                    ...
                                    xb && Y >= na && (Sa = 0);
                                    var pa = new d.Cuboid(h, M, ha, E, O, Ia, Sa, aa, ua, V, fa, t, r, ba, $a, kb, oa), Bb, Cb;
                        ...
                        if (this.end - this.start <= Rb || 0 === Rb) {
                            ...
                            if ("regular" == I || "100%" == I) {
                                ...
                                if (Ub) {
                                    ...
                                    var Vb = Va.getBBox(), Wb = Vb.width, Xb = Vb.height, bb, cb, pb = f.totalTextOffset, Yb = f.totals[K];
                                    Yb && Yb.remove();
                                    var db = 0;
            ...
            if (1 < a.length) {
                ...
                if (0 < f || 0 < v)if (p = a.join(";").split(";"), r = b.join(";").split(";"), n = g.type, "serial" == n || "radar" == n ? 0 < c.length ? (c.reverse(), e.reverse(), p = a.concat(c), r = b.concat(e)) : "radar" == n ? (r.push(0), p.push(0)) : h.rotate ? (r.push(r[r.length -
            ...
            if (1 < a.length) {
                ...
                h.push(l);
                h.push(k);
                var m = this.lineAlpha, n = this.lineThickness, h = this.dashLength, p = this.fillAlphas, q = this.lineColorR, r = this.fillColorsR, u = this.negativeLineColor, t = this.negativeFillColors, z = this.negativeFillAlphas, y = this.baseCoord, v = this.lineColorSwitched;
                v && (q = v);
            ...
            if (!isNaN(b) && !isNaN(c)) {
                ...
                f = this.bullet;
                a.bullet && (f = a.bullet);
                var k = this.bulletBorderThickness, m = this.bulletBorderColorR, n = this.bulletBorderAlpha, u = this.bulletAlpha;
                m || (m = p);
                ...
                if (this.customBullet || a.customBullet)r = this.customBullet, a.customBullet && (r = a.customBullet), r && (q && q.remove(), "function" == typeof r ? (q = new r, q.chart = e, a.bulletConfig && (q.availableSpace = c, q.graph = this, q.graphDataItem = a, q.bulletY = c, a.bulletConfig.minCoord = this.minCoord -
                    c, q.bulletConfig = a.bulletConfig), q.write(h), q = q.set) : (q = h.set(), h = h.image(r, 0, 0, g, g), q.push(h), this.centerCustomBullets && h.translate(-g / 2, -g / 2)));
                if (q) {
    ...
    d.ChartCursor = d.Class({
        construct: function (a) {
            ...
            if (this.enabled) {
                ...
                var g = c.categoryAxis, k = c.dx, l = c.dy, m = this.x + 1, n = this.y + 1, p = this.width, q = this.height, r = this.data[a], u;
            ...
            var e = b.position, d = b.inside, f = b.axisThickness, g = b.tickLength, k = this.chart, l = k.dx, k = k.dy, m = this.x, n = this.y, p = this.width, q = this.height;
            ...
            if (a) {
                var e = a.mouseX - this.x, h = a.mouseY -
                    this.y;
                if (this.drawingNow) {
                    this.drawingNow = !1;
                ...
                if (this.enabled && 0 < b.length) {
                    if (this.pan)this.rolledOver = !1; else if (this.zoomable && this.zooming) {
                        ...
                        if ("cursor" == this.type)this.rotate ? this.selectionPosY = h : this.selectionPosX = h = e, 4 > Math.abs(h - this.initialMouse) && this.fromIndex == this.index || (this.index < this.fromIndex ? (c.end = this.fromIndex, c.start = this.index) : (c.end = this.index, c.start = this.fromIndex), h = a.categoryAxis, h.parseDates && !h.equalSpacing && (b[c.start] && (c.start = b[c.start].time), b[c.end] && (c.end = a.getEndTime(b[c.end].time))), this.skipZoomDispatch || this.fire(c.type, c)); else {
                            ...
                            3 > Math.abs(e - g) && 3 > Math.abs(h - k) || (b = Math.min(g, e), f = Math.min(k, h), e = Math.abs(g - e), h = Math.abs(k -
                                h), a.hideXScrollbar && (b = 0, e = this.width), a.hideYScrollbar && (f = 0, h = this.height), c.selectionHeight = h, c.selectionWidth = e, c.selectionY = f, c.selectionX = b, this.skipZoomDispatch || this.fire(c.type, c))
                        }
...
(function () {
    ...
    d.TrendLine = d.Class({
        construct: function (a) {
            ...
            var a = this;
            a.destroy();
            var b = a.chart, c = b.container, e, h, f, g, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory, n = a.finalDate, p = a.finalCategory, q = a.valueAxis, r = a.valueAxisX, u = a.initialXValue, t = a.finalXValue, z = a.initialValue, y = a.finalValue, v = q.recalculateToPercents, w = b.dataDateFormat;
...
(function () {
    ...
    d.AmLegend = d.Class({
        construct: function (a) {
            ...
            var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, e = this.marginTop, h = this.marginBottom, f = this.horizontalGap, g = this.div, k = this.divWidth, l = this.maxColumns, m = this.verticalGap, n = this.spacing, p = k - c - b, q = 0, r = 0, u = this.container;
            ...
            if (!1 !== a.visibleInLegend) {
                ...
                var u;
                e && (e = d.fixBrakes(e), a.legendTextReal = e, u = this.labelWidth, u = isNaN(u) ? d.text(this.container, e, f, b.fontFamily, c, "start") : d.wrappedText(this.container, e, f, b.fontFamily, c, "start", !1, u,
                    0), d.setCN(b, u, "legend-label"), u.translate(this.lx + n, this.ly), l.push(u), b = u.getBBox().width, this.maxLabelWidth < b && (this.maxLabelWidth = b));
