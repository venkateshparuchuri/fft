(function () {
    ...
    l.AmPieChart = l.Class({
        inherits: l.AmSlicedChart, construct: function (d) {
            this.type = "pie";
            ...
            if (l.ifArray(d)) {
                if (0 < this.realWidth && 0 < this.realHeight) {
                    ...
                    this.realHeight = n;
                    var e = l.toCoordinate, f = e(this.marginLeft, b), a = e(this.marginRight, b), v = e(this.marginTop, n) + this.getTitleHeight(), m = e(this.marginBottom, n), A, B, k, y = l.toNumber(this.labelRadius), p = this.measureMaxLabel();
                    ...
                    for (var D, f = 0; f < d.length; f++)if (a = d[f], !0 !== a.hidden && (this.showZeroSlices || 0 !== a.percents)) {
                        var t = 360 * a.percents / 100, p = Math.sin((m + t / 2) / 180 *
                            Math.PI), C = -Math.cos((m + t / 2) / 180 * Math.PI) * (b / k), q = this.outlineColor;
                        q || (q = a.color);
                        var w = this.alpha;
                        ...
                        if (this.labelsEnabled && this.labelText && a.percents >= this.hideLabelsPercent) {
                            ...
                            if (0 <= r) {
                                var z;
                                90 >= h && 0 <= h ? (z = 0, x = "start", u = 8) : 90 <= h && 180 > h ? (z = 1, x = "start", u = 8) : 180 <= h && 270 > h ? (z = 2, x = "end", u = -8) :
                                    270 <= h && 357 >= h ? (z = 3, x = "end", u = -8) : 357 <= h && (f > D ? (z = 0, x = "start", u = 8) : (z = 3, x = "end", u = -8));
                                a.labelQuarter = z
                            } else x = "middle";
                            ...
                            if ("" !== h) {
                                ...
                                a.ty = E;
                                a.textX = t + 1.5 * u;
                                var r = h.getBBox(), F = l.rect(c, r.width + 5, r.height +
                                    5, "#FFFFFF", .005);
            ...
            if (m) {
                if (!0 === b)for (f = d + 1; f < v; f++)a[f].labelQuarter == c && (e = this.checkOverlappingReal(g, a[f], c)) && (f = v); else for (f = d - 1; 0 <= f; f--)a[f].labelQuarter == c && (e = this.checkOverlappingReal(g, a[f], c)) && (f = 0);
